  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="mx-auto max-w-3xl px-6 pt-28 pb-16 animate-fade-in">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight mb-2">Terms of Service</h1>
        ...
        <div className="prose prose-sm max-w-none space-y-8 text-[var(--color-surface-600)] leading-relaxed">
          <section>
            <h2 className="text-lg font-bold text-[var(--color-surface-900)] mb-3">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[var(--color-surface-900)] mb-3">2. Description of Service</h2>
            ...
            <p className="mt-2"><strong className="text-[var(--color-surface-900)]">Important:</strong> ContractClear AI is not a law firm and does not provide legal advice. The analysis output is for informational purposes only and should not be relied upon as a substitute for professional legal counsel.</p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-[var(--color-surface-900)] mb-3">3. User Responsibilities</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[var(--color-surface-900)] mb-3">4. Data and Privacy</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[var(--color-surface-900)] mb-3">5. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[var(--color-surface-900)] mb-3">6. Intellectual Property</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[var(--color-surface-900)] mb-3">7. Termination</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[var(--color-surface-900)] mb-3">8. Changes to Terms</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[var(--color-surface-900)] mb-3">9. Contact</h2>
        ...
        <div className="mt-12 pt-6 border-t border-[var(--color-surface-200)] text-center">
          <Link href="/privacy" className="text-sm text-[var(--color-brand-600)] hover:text-[var(--color-brand-700)] transition-colors">
            View Privacy Policy
          </Link>
        </div>
      </main>
