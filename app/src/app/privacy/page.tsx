      ...
      <main className="mx-auto max-w-3xl px-6 pt-28 pb-16 animate-fade-in">
        ...
        <div className="prose prose-invert prose-sm max-w-none space-y-8 text-gray-300 leading-relaxed">
          <section>
            ...
            <p><strong className="text-white">Account Information:</strong> When you create an account, we collect your email address, name, and authentication credentials via Supabase.</p>
            <p className="mt-2"><strong className="text-white">Documents:</strong> When you upload contracts for analysis, we process the PDF content through Google&apos;s Gemini AI API. Documents are stored in our secure Supabase database associated with your account.</p>
            <p className="mt-2"><strong className="text-white">Usage Data:</strong> We collect information about your interactions with the service, including documents analyzed, features used, and timestamps.</p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1">
              ...
              <li><strong className="text-white">Inngest:</strong> Background job processing</li>
            </ul>
